...
public class automation_invaliddetails_stepdef extends library
{

automation_invaliddetails_page id = new automation_invaliddetails_page(driver);
seleniumutil util;
...
public void click_on_submit_button() throws Throwable 
{
	...
	id.Submit();
	 util = new seleniumutil(driver);
		util.takeSnapShot("C:\\Users\\majeti\\eclipse-workspace\\AUTOMATIONTESTING_PROJECT\\src\\test\\resources\\screenshots\\invaliddetails.png");
	id.quit();
}
}
